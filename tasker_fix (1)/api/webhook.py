...
@app.get("/api/webhook")
def health():
    return {"status": "ok", "service": "Telegram Webhook Active"}
...
async def telegram_webhook(request: Request):
    ...
    if "message" in update:
        ...
        if text.startswith("/start"):
            ...
            markup = {
                "inline_keyboard": [
                    [{"text": "🚀 Открыть трекер", "web_app": {"url": "https://tasker-pits-bot.vercel.app"}}]
                ]
            }
        ...
        keyboard = {
            "inline_keyboard": [
                ...
                [{"text": "🚀 Открыть в App", "web_app": {"url": "https://tasker-pits-bot.vercel.app"}}]
            ]
        }
